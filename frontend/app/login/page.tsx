...
import { AlertCircle, ArrowLeft, KeyRound, Lock, User, ArrowRight, Eye, EyeOff } from 'lucide-react';
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <Input
                                    ...
                                    required
                                    className="bg-background border-white/5 pl-10 h-10 pr-10 focus:border-primary/50 transition-colors font-mono text-sm"
                                />
                                <button
                                    type="button"
